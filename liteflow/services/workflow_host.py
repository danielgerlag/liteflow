...
from liteflow.models import WorkflowInstance, Workflow, Event
from liteflow.abstractions import IExecutionPointerFactory, IPersistenceProvider, IWorkflowHost, IQueueProvider, IBackgroundService, IWorkflowRegistry, WORKFLOW_QUEUE, EVENT_QUEUE


class WorkflowHost(implements(IWorkflowHost)):

    def __init__(self, persistence_service: IPersistenceProvider, queue_service: IQueueProvider, pointer_factory: IExecutionPointerFactory, registry: IWorkflowRegistry, background_services: List[IBackgroundService]):
